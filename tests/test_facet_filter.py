...
def test_facets_not_existing_role(
    ...
    assert data["aggregations"] == {'metadata_date': {'buckets': [], 'label': 'metadata/date.label', 'interval': '1y'},
                                    'metadata_num': {'buckets': [], 'label': 'metadata/num.label'},
                                    'metadata_num_increased': {'buckets': [], 'label': 'metadata/num_increased.label'},
                                    'metadata_subjects_cs': {'buckets': [
                                        {'key': 'jupii', 'doc_count': 1, 'label': 'jupii', 'is_selected': False}],
                                        'label': 'metadata/subjects.label'},
                                    'metadata_subjects_en': {'buckets': [
                                        {'key': 'jej', 'doc_count': 1, 'label': 'jej', 'is_selected': False}],
                                        'label': 'metadata/subjects.label'}, 'metadata_subjects': {
            'buckets': [{'key': 'jej', 'doc_count': 1, 'label': 'jej', 'is_selected': False}],
            'label': 'metadata/subjects.label'}}
...
def test_facets_with_system_fields(
    ...
    assert data["aggregations"] == {'metadata_date': {'buckets': [], 'label': 'metadata/date.label', 'interval': '1y'},
                                    'metadata_num': {
                                        'buckets': [{'key': '1', 'doc_count': 1, 'label': '1', 'is_selected': False},
                                                    {'key': '2', 'doc_count': 1, 'label': '2', 'is_selected': False}],
                                        'label': 'metadata/num.label'},
                                    'metadata_num_increased': {
                                        'buckets': [{'key': '2', 'doc_count': 1, 'label': '2', 'is_selected': False},
