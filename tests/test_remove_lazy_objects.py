...
def obj4():
    return {
        ...
        "c": (
            "tuple_item1",
            "tuple_item2",
            [80, LocalProxy(lambda: "lazy")],
            {"key_in_tuple": "value_in_tuple"},
        ),
    }
...
def obj6():
    return {
        ...
        "b": {
            "100": 100,
            "200": 200,
            "frozenset": frozenset([300, LocalProxy(lambda: "lazy"), 80]),
        },
        "c": (
            "tuple_item1",
            "tuple_item2",
            [80, LocalProxy(lambda: "lazy")],
            {"key_in_tuple": ["value_in_tuple", LocalProxy(lambda: "lazy")]},
        ),
    }
