...
Report bugs at <https://github.com/oarepo/oarepo-runtime/issues>.
...
<https://github.com/oarepo/oarepo-runtime/issues>.
...
Ready to contribute? Here's how to set up `oarepo-runtime` for local
development.

1. Fork the `oarepo/oarepo-runtime` repo on GitHub.

2. Clone your fork locally:

   ```console
   git clone git@github.com:your_name_here/oarepo-runtime.git
   ```
