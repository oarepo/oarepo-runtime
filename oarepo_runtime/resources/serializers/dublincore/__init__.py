...
from ...signposting import record_dict_to_datacite_export
...
class DublinCoreXMLSerializer(MarshmallowSerializer):
    ...
    def preload(self, obj: dict) -> dict:
        """Preload datacite which will be used to construct dublin core export."""
        return record_dict_to_datacite_export(obj)
